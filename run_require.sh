...
cp /usr/local/lib/python2.7/dist-packages/gym/envs/__init__.py requirement_files/env_init.py
...
cp /usr/local/lib/python2.7/dist-packages/gym/envs/mujoco/__init__.py requirement_files/mujoco_init.py
...
cp requirement_files/pa.py /usr/local/lib/python2.7/dist-packages/gym/envs/mujoco/

# copy pa xml file
cp requirement_files/pa.xml /usr/local/lib/python2.7/dist-packages/gym/envs/mujoco/assets/
